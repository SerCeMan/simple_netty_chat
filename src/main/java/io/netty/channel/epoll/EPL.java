 ...
 */
public final class EPL extends SingleThreadEventLoop {
    private static final InternalLogger logger = InternalLoggerFactory.getInstance(EPL.class);
    private static final AtomicIntegerFieldUpdater<EPL> WAKEN_UP_UPDATER;

    static {
        AtomicIntegerFieldUpdater<EPL> updater =
                PlatformDependent.newAtomicIntegerFieldUpdater(EPL.class, "wakenUp");
        if (updater == null) {
            updater = AtomicIntegerFieldUpdater.newUpdater(EPL.class, "wakenUp");
        }
    ...
    public IntObjectMap<AbstractEpollChannel> getChannels() {
        return channels;
    }
    ...
    public EPL(EventLoopGroup parent, ThreadFactory threadFactory, int maxEvents) {
